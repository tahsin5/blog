...
class CreateTable:
    ...
    def _execute_create_table(self, sql_statement):
    ...
    def init_tables(self):
        ...
        create_tables_method_list = [
                                    ...
                                    self._create_post_category_table(),  
                                    self._create_post_tag_table(), 
                                    ]
    ...
    def _create_post_table(self):
        ...
        self._execute_create_table(sql_statement)
        self._table = 'post'
    ...
    def _create_post_category_table(self):
    ...
    def _create_post_tag_table(self):
